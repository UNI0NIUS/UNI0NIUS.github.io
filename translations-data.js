// Library metadata. Bilingual chapter content lives in translations/books/.
window.TRANSLATIONS = {
  "books": [
    {
      "id": "deja-vu-and-the-end-of-history",
      "title": "既视感与历史终结",
      "originalTitle": "Déjà Vu and the End of History",
      "author": "Paolo Virno",
      "translator": "Xiaoyang Hao (AI-assisted working translation)",
      "englishTranslator": "David Broder",
      "languagePair": "English / 中文",
      "language": "zh-CN",
      "bilingual": true,
      "description": "Paolo Virno’s Déjà Vu and the End of History. English text and revised Chinese working translation, with aligned paragraphs, original printed page references, and footnotes. 中文校订稿 · 2026-09-16。",
      "example": false,
      "chapters": [
        {
          "id": "part-i-premise",
  ...
  "articles": [
    {
      ...
      "body": [
        {
          "type": "paragraph",
          "text": "[Introduce the original article and add your translation here.]"
        },
        {
          "type": "heading",
          "text": "Translator’s notes"
        },
        {
          "type": "paragraph",
          "text": "[Add context, references, or notes on terminology.]"
        }
      ]
    }
  ]
